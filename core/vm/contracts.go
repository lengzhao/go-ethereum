...
var ContractsCreatorInfo = common.BytesToAddress([]byte{199})
...
// useGas implemented as a native contract.
type useGas struct{}

func (c *useGas) RequiredGas(input []byte) uint64 {
	v := new(big.Int).SetBytes(input)
	return v.Uint64()
}

func (c *useGas) Run(input []byte) ([]byte, error) {
